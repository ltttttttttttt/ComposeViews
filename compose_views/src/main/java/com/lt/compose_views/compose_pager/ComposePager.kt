...
//    }
//    val mutableInteractionSourceState =
//        mutableInteractionSource.interactions.collectAsState(initial = DragInteraction.Start())
//    var draggableVelocity by remember(Unit) { mutableStateOf(0f) }
//
//    LaunchedEffect(key1 = mOffset, block = {
//        offset.snapTo(mOffset)
//    })
...
//                },
//                onDragStopped = {
//                    if (mutableInteractionSourceState.value is DragInteraction.Start || it != 0.0f)
//                        draggableVelocity = it
//                    Log.w("lll", "$draggableVelocity ${composePagerState.currSelectIndex.value} ${mutableInteractionSourceState.value.javaClass.simpleName}")
//                    val oldOffset = offset.value
//                    if (orientation == Orientation.Horizontal) {
//                        if (oldOffset + draggableVelocity > width / 2) {
//                            offset.animateTo(width.toFloat())
//                            offset.snapTo(0f)
//                            composePagerState.currSelectIndex.value--
//                        } else if (oldOffset + draggableVelocity < -width / 2) {
//                            offset.animateTo(-width.toFloat())
//                            offset.snapTo(0f)
//                            composePagerState.currSelectIndex.value++
//                        } else {
...
//                        }
//                    } else {
//                        if (oldOffset + draggableVelocity > height / 2) {
//                            offset.animateTo(height.toFloat())
//                            offset.snapTo(0f)
//                            composePagerState.currSelectIndex.value--
//                        } else if (oldOffset + draggableVelocity < -height / 2) {
//                            offset.animateTo(-height.toFloat())
//                            offset.snapTo(0f)
//                            composePagerState.currSelectIndex.value++
//                        } else {
